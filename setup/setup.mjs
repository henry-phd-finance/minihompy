...
if(args.includes('--help') || args.length===0) {
  ...
  try {
    ...
    await (command==='navigation'?verifyNavigationSetup:command==='writing'?upgradeMemberWriting:command==='home-data'?upgradeHomeData:runSetup)({config,command,target:process.cwd(),dryRun,...credentials});

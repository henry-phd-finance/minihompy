...
for(const required of ['index.html','photo-media-client.js','content-access.js','content-folders-repository.js','content-folders.js','member-writing-config.js','member-writing-client.js','member-writing-runtime.js','login/index.html','assets/login-flow.js','assets/login.css','visitor-identity-login.js','visitor-identity.js','member-navigation.js','author-navigation.js','surf-navigation.js','home-data-config.js','visit-counts.js','home-repository.js','home-activity.js','post-routes.js','post-location-repository.js'])assert.ok(paths.includes(resolve(root,required)),required);
